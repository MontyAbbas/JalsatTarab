const members = [
  ...
  { name: 'Montasir Abbas', role: 'Lead vocal · Oud', image: 'montasir-abbas.png', bio: 'Montasir started playing Sudanese-style oud in the late 1980s. Over the past decade, he has studied Arabic music maqams with Simon Shaheen, Cherbel Rouhana, Issa Boulos, and others, while listening closely to Hashim Mirghani.', tags: ['Sudanese golden age', 'Haqiba', 'Modern Arabic'], facts: [['From', 'Omdurman, Sudan'], ['Maqams', 'Nahawand, Kurd, pentatonic'], ['Languages', 'Sudanese, Egyptian, Khaliji'], ['Instrument', 'Oud'], ['Moment', 'SASF 2026']], quote: 'I have spent my career teaching how things move: traffic through cities, signals, patterns in data. It turns out that is also a fair description of a song.', link: { label: 'Read his poems and songs at montasirabbas.com', url: 'https://montasirabbas.com' } },
  { name: 'Sharaf Yaseen', role: 'Lead vocal · Oud', image: 'https://images.unsplash.com/photo-1520523839897-bd0b52f945a0?auto=format&fit=crop&w=900&q=85', bio: 'Sharaf sings and plays oud with the ensemble. He is drawn to any song that speaks to the heart: music that pulses with goodness, truth, beauty, and humanity.', tags: ['Oud', 'Tarab'], facts: [['Instrument', 'Oud'], ['Repertoire', 'Songs that speak to the heart, pulsing with goodness, truth, beauty, and humanity']], quote: 'Creating for the sheer joy of creating.' },
...
const memberArabic = {
  ...
  'Montasir Abbas': { name: 'منتصر عباس', role: 'غناء رئيسي · عود', bio: 'بدأ منتصر عزف العود بالطريقة السودانية في أواخر الثمانينيات. وخلال العقد الماضي تعلّم مقامات الموسيقى العربية على يد سيمون شاهين وشربل روحانا وعيسى بولس وغيرهم، مع استماع متواصل إلى هاشم ميرغني.', tags: ['العصر الذهبي السوداني', 'الحقيبة', 'العربي الحديث'], facts: [['من', 'أم درمان، السودان'], ['المقامات', 'نهاوند، كرد، خماسي'], ['اللغات', 'السودانية، المصرية، الخليجية'], ['الآلة', 'العود'], ['مناسبة', 'SASF 2026']], quote: 'أمضيتُ مسيرتي أُدرِّس كيف تتحرّك الأشياء: المرور في المدن، والإشارات، والأنماط في البيانات. وتبيّن لي أنّ هذا وصفٌ صادق للأغنية أيضًا.', link: { label: 'اقرأ قصائده وأغانيه في montasirabbas.com', url: 'https://montasirabbas.com' } },
  'Sharaf Yaseen': { name: 'شرف يس', role: 'غناء رئيسي · عود', bio: 'يغني شرف ويعزف العود مع الفرقة، ويميل إلى كل ما خاطب الوجدان من أغانٍ تنبض بقيم الخير والحق والجمال والإنسانية.', tags: ['العود', 'الطرب'], facts: [['الآلة', 'العود'], ['ما يغنّيه', 'كل ما خاطب الوجدان من أغانٍ تنبض بقيم الخير والحق والجمال والإنسانية']], quote: 'تعاطي الإبداع من أجل متعة الإبداع.' },
...
function selectMember(index) {
  ...
  const link = localized?.link || member.link;
  const linkElement = detail.querySelector('.member-link');
  linkElement.hidden = !link;
  if (link) { linkElement.href = link.url; linkElement.innerHTML = `${link.label} <span>↗</span>`; }
