const members = [
  { name: 'Tawfieg Osman', role: 'Lead vocal · Percussion', image: 'https://images.unsplash.com/photo-1529139574466-a303027c1d8b?auto=format&fit=crop&w=900&q=85', bio: 'Tawfieg began singing in high school, with his serious musical journey taking shape during college.', tags: ['Sudanese golden age', 'Haqiba'], facts: [['From', 'Omdurman, Sudan'], ['Languages', 'Arabic'], ['Instruments', 'Keyboard · beginner percussion'], ['Signature songs', 'حنيني إليك · محمد ميرغني; عاطفة وحنان · محمد ميرغني; الحجروك عليا · يوسف الموصلي'], ['Influence', 'محمد ميرغني']], quote: 'Add Tawfieg’s own words here.' },
