...
const memberArabic = {
  ...
  'Khidir Maaz': { name: 'خضر معاز', role: 'عضو في الفرقة', bio: 'هذا الملف جاهز لإضافة دور خضر وخلفيته وقصته الموسيقية.', tags: ['الملف قيد الإعداد'], quote: 'أضف كلمات خضر هنا.' },
...
const rollingPictures = [
  ...
  { image: 'pictures/img_2217.jpg', title: { en: 'A night in Indiana', ar: 'ليلة في إنديانا' }, detail: { en: 'After the show', ar: 'بعد الحفل' } },
